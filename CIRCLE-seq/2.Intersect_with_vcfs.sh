...
mkdir -p circleseq_6mismatches_intersection_padded_June2022_ignoreStrands
...
do 
    ...
    do 
        echo $i 
        bedtools intersect -a $i -b $BEDfilesFolder/${b}_identified_matched.bed -wo > circleseq_6mismatches_intersection_padded_June2022_ignoreStrands/$a.$b.vcf_overlaps.txt 
    done
